...
const About = () => {
    return (
        <div className="hero min-h-screen bg-base-200 mb-36">
  <div className="hero-content flex-col lg:flex-row">
    <div className='lg:w-1/2 relative'>
    <img src={ person } 
    className="w-3/4 rounded-lg shadow-2xl" />
    <img src={ parts } 
    className="w-1/2 rounded-lg shadow-2xl absolute right-10 top-1/2 border-white border-8" />
    </div>
    <div className='lg:w-1/2 space-y-5'>
      <h5 className="sm:mt-5 text-orange-500 font-bold text-xl">About Us</h5>
      ...
      <button className="text-black btn btn-warning">Get Started</button>
    </div>
  </div>
</div>
    );
